...
filename = 'Clean_Data_1945Onwards.csv'
# filename = 'Clean_Data_1945andExcludeLow.csv'

# Extremely scuffed filename manager; I should've written a function that accepted the filename as a parameter
